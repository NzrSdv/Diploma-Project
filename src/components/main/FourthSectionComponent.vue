...
<template>
  <section class="">
    <div class="container-md flex justify-center items-center gap-25">
      ...
      <div class="max-w-150 flex flex-col items-start justify-center gap-7 font-main">
        ...
        <p class="max-w-119 text-start">
          ...
          тщательно подобранную коллекцию вин из разных уголков планеты: от
          знаменитых французских шато до молодых виноделен Нового Света.
        </p>
      </div>
    </div>
  </section>
