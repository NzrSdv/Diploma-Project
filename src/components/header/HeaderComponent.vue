...
<template lang="">
  <header class="h-20 bg-main-2 flex items-center justify-center px-10 z-30">
    <div class="container flex items-center justify-between">
      ...
      >
        <ul
          class="flex lg:flex-row flex-col items-center lg:justify-center justify-start px-10 gap-14 bg-white lg:static fixed top-20 md:pt-0 pt-10 right-0 bottom-0 z-20"
        >
          <li
            :class="[
