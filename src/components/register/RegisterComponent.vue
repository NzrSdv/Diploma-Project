...
<template>
  ...
  >
    <div
      class="flex flex-col items-center justify-center text-center md:gap-5 gap-2"
    >
    ...
    <div class="flex flex-col items-center justify-center md:gap-6 gap-2">
      <div
        class="w-full flex md:flex-row flex-col items-center justify-center md:gap-8 gap-2"
      >
        <SignInInput
